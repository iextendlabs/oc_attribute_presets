...
class ControllerCatalogAttribute extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
              ...
              $attrid = $this->model_catalog_attribute->addAttribute($this->request->post);
              $this->model_catalog_attribute->addAttributePresets($attrid, $this->request->post['attribute_preset']);
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_attribute->editAttribute($this->request->get['attribute_id'], $this->request->post);
              ...
              $this->model_catalog_attribute->addAttributePresets($this->request->get['attribute_id'], $this->request->post['attribute_preset']);
		...
		if (isset($this->request->get['attribute_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			$attribute_info = $this->model_catalog_attribute->getAttribute($this->request->get['attribute_id']);
              ...
              if (isset($this->request->post['attribute_id'])) {
              		$data['attribute_presets'] = $this->request->post['attribute_id'];
              } elseif (isset($this->request->get['attribute_id'])) {
              		$data['attribute_presets'] = $this->model_catalog_attribute->getAttributePresets($this->request->get['attribute_id']);

              } else {
              	$data['attribute_presets'] = array();
              }
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name'])) {
			...
			foreach ($results as $result) {
              ...
              $attribute_info = $this->model_catalog_attribute->getPresets($result['attribute_id']);                    
