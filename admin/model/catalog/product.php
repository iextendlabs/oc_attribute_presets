	...
	public function getProductAttributes($product_id) {
		...
		foreach ($product_attribute_query->rows as $product_attribute) {
          ...
          $product_attribute_presets = array();
        	$product_attribute_presets_query = $this->db->query("SELECT text FROM " . DB_PREFIX . "attribute_to_preset WHERE attribute_id=".$product_attribute['attribute_id']);
          foreach ($product_attribute_presets_query->rows as $product_attribute_preset) {
			...
			$product_attribute_data[] = array(
              ...
              'product_attribute_presets' 		=> $product_attribute_presets,
